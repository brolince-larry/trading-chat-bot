<script lang="ts">
	const PATHS: Record<string, string> = {
		...
		markets: 'M3 17l6-6 4 4 8-8M15 6h6v6',
		bot: 'M12 2v3M7 8h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2zM8 13h.01M16 13h.01M9 17h6',
		portfolio: 'M3 8h18v11a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1zM8 8V6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2',
		shield: 'M12 2l8 4v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V6z',
		zap: 'M13 2 4 14h6l-1 8 9-12h-6z',
		analytics: 'M4 20V10M11 20V4M18 20v-7',
		reports: 'M6 2h9l5 5v15H6zM14 2v6h6M8 13h8M8 17h8',
		settings:
		...
		calculator:
			'M4 2h16v20H4zM8 6h8M8 10h.01M12 10h.01M16 10h.01M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01M16 18h.01',
		bell: 'M18 8a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9M13.7 21a2 2 0 0 1-3.4 0',
		search: 'M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16zM21 21l-4.35-4.35',
		sun: 'M12 1v2M12 21v2M4.2 4.2l1.4 1.4M18.4 18.4l1.4 1.4M1 12h2M21 12h2M4.2 19.8l1.4-1.4M18.4 5.6l1.4-1.4M12 6a6 6 0 1 0 0 12 6 6 0 0 0 0-12z',
